...
extern uint64 sys_team_race_reset(void);
extern uint64 sys_team_score_inc(void);
extern uint64 sys_team_race_winner(void);
...
static uint64 (*syscalls[])(void) = {
    ...
    [SYS_team_race_reset] sys_team_race_reset,
    [SYS_team_score_inc] sys_team_score_inc,
    [SYS_team_race_winner] sys_team_race_winner,
